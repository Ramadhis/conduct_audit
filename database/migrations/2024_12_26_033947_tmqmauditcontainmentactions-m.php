...
return new class extends Migration
{
    ...
    {
        Schema::create('tmqmauditcontainmentactions', function (Blueprint $table) {
            $table->id('i_id_containment_nmbrn'); // Primary Key
    ...
    {
        Schema::dropIfExists('tmqmauditcontainmentactions');
    }
};
